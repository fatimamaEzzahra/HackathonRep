            ...
            {isLoggedIn ?
              (
                <div className="hidden gap-4 lg:flex items-center">
                 ...
                 <DropDownProfile isVisible={visibility}/>
                 </div>
                <Link to='cart'  className="text-blue-gray-900 text-2xl flex">
                  <BsBag/>
                 <span style={{
                            backgroundColor:'red',
                            height:'13px',
  ...
  return (
    <Navbar className="mx-auto max-w-screen px-4 py-2  glassbar" style={{position:'sticky', top: 0,zIndex: 1000,borderRadius:0}}>
      <div className="flex items-center justify-between navv  text-blue-gray-900"  >
        ...
        >
          {/* <Link to='/'>
          <img src={logo} style={{height:'50px'}}  alt="" /></Link> */}
        </Typography>
      ...
      <Collapse open={openNav}>
        ...
        <Link to='cart'  className="text-blue-gray-900 mr-7 mb-3 d-flex"><FaShoppingCart className="text-2xl mr-4"/>
